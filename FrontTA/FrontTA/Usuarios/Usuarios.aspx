            ...
            function wireUp() {
                ...
                if (btnDel && overlay) {
                    btnDel.addEventListener('click', function () {
                        ...
                        if (subTitle) { subTitle.textContent = 'Eliminar Usuario'; subTitle.style.display = 'inline-block'; }
                    });
                }
                ...
                if (btnDoDelete) {
                    btnDoDelete.addEventListener('click', function () {
                        ...
                        // TODO: llamada real a BD/API (Delete)
                        sel.remove();
                        closeDeleteUI();
                    });
                }
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_Contenido" runat="server">
    <div class="container-fluid familias-container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-2">
            <div></div>
<%--            <span id="subTitle" class="header-cta" style="display: none;">Eliminar Usuario</span>--%>
        </div>
        ...
        <div class="tabla-box">
            <asp:GridView ID="gvUsuarios" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="UltimoAccesoStr" HeaderText="Último Acceso" SortExpression="UltimoAcceso" />
                </Columns>
                <EmptyDataTemplate>

...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Scripts" runat="server">
    <style>
        ...
        /* ===== top layout (Año | Crear Matrícula | iconos) ===== */
        .top-grid {
            display: grid;
        ...
        .icon-bar a, .icon-bar button, .btn-icon, .btn-icon-2 {
            ...
            .btn-accept:focus, .btn-cancel:focus,
            .btn-icon:focus, .btn-icon-2:focus,
            .icon-bar a:focus, .icon-bar button:focus {
        ...
        .btn-icon-2,
        .btn-search {
            color: #fff !important; /* texto/icono base */
        }

            .btn-icon-2 i,
            .btn-search i {
                color: #fff !important; /* Font Awesome */
            }

            .btn-icon-2:hover i,
            .btn-search:hover i {
                color: #fff !important; /* mantener blanco en hover */
            }
    ...
    <script>
        // Selección de filas (pinta celeste y habilita ✔)
        ...
        // Confirmar selección (Alumno)
        function ConfirmAlumno() {
            const tr = document.querySelector('#gvAlumnosModal tr.row-selected'); if (!tr) return false;
            const c = tr.children;
        ...
        // Confirmar selección (Aula)
        function ConfirmAula() {
            const tr = document.querySelector('#gvAulasModal tr.row-selected'); if (!tr) return false;
            const c = tr.children;
        ...
        document.addEventListener('DOMContentLoaded', function () {
            // Enlazar grids (para selección)
            wireSelectableGrid('gvAlumnosModal', 'btnAlumnoOk');
            wireSelectableGrid('gvAulasModal', 'btnAulaOk');

            // Buscar Alumno (cliente)
            const doBuscarAlumno = () => filterTable('gvAlumnosModal', [
            ...
            document.getElementById('btnBuscarAlumno').addEventListener('click', doBuscarAlumno);

            // Buscar Aula (cliente)
            const doBuscarAula = () => filterTable('gvAulasModal', [
                { col: 1, q: () => document.getElementById('f_nomAula').value },
                { col: 2, q: () => document.getElementById('f_nomGrado').value }
            ]);
            document.getElementById('btnBuscarAula').addEventListener('click', doBuscarAula);
            ...
            <div class="fieldset">
                <div class="mb-2 row g-4 align-items-start">
                    ...
                    <div class="col-lg-7">
                        <div class="mb-3 row">
                            <div class="col-md-4">
                                <label class="form-label">Alumno:</label></div>
                            <div class="col-md-7">
                        ...
                        <div class="mb-3 row">
                            <div class="col-md-4">
                                <label class="form-label">Monto:</label></div>
                            <div class="col-md-7">
                                <asp:TextBox ID="txtMonto" runat="server" CssClass="form-control readonly-gray" ReadOnly="true"></asp:TextBox></div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-7">
                                <asp:TextBox ID="txtActivo" runat="server" CssClass="form-control readonly-gray" ReadOnly="true" Text="Sí"></asp:TextBox></div>
                        </div>
                    </div>
            ...
            <div class="modal-box">
                <div class="modal-inner">
                    ...
                    <div class="busqueda-box">
                        <div class="row g-3 align-items-end">
                            <div class="col-md-2">
                                <label class="mini-label">Código Familia</label>
                                <input id="f_codFam" type="text" class="form-control" />
                            </div>
                            <div class="col-md-2">
                                <label class="mini-label">Código Alumno</label>
                                <input id="f_codAlu" type="text" class="form-control" />
                            </div>
                            <div class="col-md-2">
                                <label class="mini-label">Apellido Paterno</label>
                                <input id="f_apePat" type="text" class="form-control" />
                            </div>
                            <div class="col-md-2">
                                <label class="mini-label">DNI</label>
                                <input id="f_dni" type="text" class="form-control" />
                            </div>
                            <div class="col-md-2">
                                <label class="mini-label">Nombre</label>
                                <input id="f_nombre" type="text" class="form-control" />
                            </div>
                            <div class="col-md-2 d-flex justify-content-center">
                                <button type="button" id="btnBuscarAlumno" class="btn-search" title="Buscar">
                                    <i class="fa-solid fa-magnifying-glass"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="tabla-box grid-selectable">
                        <asp:GridView ID="gvAlumnosModal" runat="server" AutoGenerateColumns="False"
                    ...
                    <div class="modal-footer">
                        <asp:LinkButton ID="btnAlumnoOk" runat="server" CssClass="btn-accept"
                            OnClientClick="return ConfirmAlumno();" UseSubmitBehavior="false" ToolTip="Seleccionar">
                            <i class="fa-solid fa-check"></i>
                        </asp:LinkButton>
                        <asp:LinkButton ID="btnCloseAlumno" runat="server" CssClass="btn-cancel"
            ...
            <div class="modal-box">
                <div class="modal-inner">
                    ...
                    <div class="busqueda-box">
                        <div class="row g-3 align-items-end">
                            <div class="col-md-5">
                                <label class="mini-label">Nombre de Aula</label>
                                <input id="f_nomAula" type="text" class="form-control" />
                            </div>
                            <div class="col-md-5">
                                <label class="mini-label">Nombre de Grado Académico</label>
                                <input id="f_nomGrado" type="text" class="form-control" />
                            </div>
                            <div class="col-md-2 d-flex justify-content-center">
                    ...
                    <!-- tabla -->
                    <div class="tabla-box grid-selectable">
                        <asp:GridView ID="gvAulasModal" runat="server" AutoGenerateColumns="False"
                            CssClass="table table-bordered table-hover align-middle mb-0"
                            ClientIDMode="Static" ShowHeaderWhenEmpty="true"
                            OnRowDataBound="gv_RowDataBound">
                            <HeaderStyle CssClass="table-header" />
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:LinkButton ID="btnCloseAula" runat="server" CssClass="btn-cancel"

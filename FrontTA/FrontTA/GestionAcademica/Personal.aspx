            ...
            function wireUp() {
                ...
                if (btnView) {
                    btnView.addEventListener('click', function () {
                        ...
                        window.location.href = "<%= ResolveUrl("~/GestionAcademica/ConsultarPersonal.aspx") %>?id=" + encodeURIComponent(id);
                    });
                }
                if (btnEdit) {
                    btnEdit.addEventListener('click', function () {
                        const sel = getSelected(); if (!sel) return;
                        const id = sel.getAttribute('data-id');
                        window.location.href = "<%= ResolveUrl("~/GestionAcademica/EditarPersonal.aspx") %>?id=" + encodeURIComponent(id);
                    });
                }
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_Contenido" runat="server">
    <div class="container-fluid familias-container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-2">
            <div></div>
            <span id="subTitle" class="header-cta" style="display: none;">Eliminar Personal</span>
        </div>
        ...
        <div id="confirmDelete" class="confirm-overlay" aria-hidden="true">
            <div class="confirm-box">
                <div class="confirm-title">¿Eliminar registro de personal?</div>

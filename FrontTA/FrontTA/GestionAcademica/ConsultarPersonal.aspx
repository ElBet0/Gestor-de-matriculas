                ...
                <div class="col-lg-8">
                    <div class="fieldset">
                        ...
                        <div class="row g-3 align-items-center mb-2">
                            ...
                            <div class="col-7">
                                <asp:TextBox ID="txtFechaInicio" runat="server" CssClass="form-control input-disabled" ReadOnly="true" TextMode="Date"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-center mb-2">
                            ...
                            <div class="col-7">
                                <asp:TextBox ID="txtFechaFin" runat="server" CssClass="form-control input-disabled" ReadOnly="true" TextMode="Date"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-7">
                                <!-- DropDownList deshabilitado para conservar el icono de despliegue -->
                                <asp:DropDownList ID="ddlTipoContrato" runat="server" CssClass="form-control input-disabled" Enabled="false">

            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    <div class="fieldset">
                        ...
                        <!-- Grado Académico (DropDown bloqueado) -->
                        <div class="row g-3 align-items-center mb-2">
                            <div class="col-5 text-end"><label class="form-label">Grado Académico:</label></div>
                            <div class="col-7">
                                <asp:DropDownList ID="ddlGrado" runat="server" CssClass="form-select select-disabled" Enabled="false"></asp:DropDownList>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-center mb-2">
                            ...
                            <div class="col-7">
                                <asp:TextBox ID="txtActivo" runat="server" CssClass="form-control input-disabled" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>

                        <!-- Capacidad -->
                        <div class="row g-3 align-items-center mb-2">
                            <div class="col-5 text-end"><label class="form-label">Capacidad:</label></div>
                            <div class="col-7">
                                <asp:TextBox ID="txtCapacidad" runat="server" CssClass="form-control input-disabled" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>

                        <!-- Vacantes -->
                        <div class="row g-3 align-items-center">
                            <div class="col-5 text-end"><label class="form-label">Vacantes:</label></div>
                            <div class="col-7">
                                <asp:TextBox ID="txtVacantes" runat="server" CssClass="form-control input-disabled" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>
                    </div>

...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_Title" runat="server">
    Colegio Rafael Mariscal Quintanilla - Crear Alumno
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_Contenido" runat="server">
    <div class="container-fluid alumnos-container">
        ...
        <div class="toolbar mb-3">
            <div class="icon-bar">
                <!-- ACTIVO (Agregar) -->
                <button type="button" class="btn-icon btn-active" title="Añadir Alumno">
            ...
            <span class="header-cta">Crear Alumno</span>
        </div>
     ...
     <i class="fa-solid fa-magnifying-glass"></i>
                ...
                <div class="modal-footer">
                    <div class="action-buttons mt-3">
                        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn-accept" Text="<i class='fa-solid fa-check'></i>" OnClick="btnConfirmar_Click" ToolTip="Crear y volver">

...
//        Alumno _alumno = new Alumno("Manuel", 102, sdf.parse("08-09-1478"), sdf.parse("02-03-1978"), 'M', "Judio", _familia2, "Problematico", 1000);
//        AlumnoDAO alumnoDAO = new AlumnoImpl();
//        
//        //---------------INSERTAR 
//        alumnoDAO.insertar(_alumno);
//        _alumno = new Alumno("Pedrito", 103, sdf.parse("08-09-1478"), sdf.parse("02-03-1978"), 'M', "Judio", _familia, "Problematico", 1000);
//        alumnoDAO.insertar(_alumno);
//        
//        //-------------------MODIFICAR

...
public class PersonalImp implements PersonalDAO {
    ...
    public int modificar(Personal personal) {
        ...
        in.put(4, personal.getApellido_paterno());
        in.put(5, personal.getApellido_materno());
        in.put(6, personal.getCorreo_electronico());
        in.put(7, personal.getTelefono());
        in.put(8, personal.getSalario());
        in.put(9, new Date(personal.getFecha_Contratacion().getTime()));
        in.put(10, new Date(personal.getFin_fecha_Contratacion().getTime()));
        in.put(11, personal.getTipo_contrato().toString());
    ...
    public Personal obtener_por_id(int idObjeto) {
        ...
        try {
            while (rs.next()) {
                ...
                personal.setFin_fecha_Contratacion(rs.getDate("fin_fecha_contratacion"));
                personal.setTipo_contrato(TipoContrato.valueOf(rs.getString("tipo_contrato")));
                Cargo cargo = new Cargo();
                cargo.setCargo_id(rs.getInt("cargo_id"));

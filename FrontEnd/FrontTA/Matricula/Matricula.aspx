...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Scripts" runat="server">
    <style>
        ...
        .count-pill {
            display: flex;               /* center contents horizontally & vertically */
            align-items: center;
            justify-content: center;
            ...
            padding: 0 .5rem;          /* small horizontal padding to avoid clipping */
            line-height: normal;       /* avoid vertical centering issues with line-height */
        }
    ...
    <div id="ovCrear" class="overlay" aria-hidden="true">
        <div class="modal-box">
            <div class="modal-inner">
                ...
                <div class="mb-3">
                    <label class="mini-label">Nombre Año</label>
                    <asp:TextBox ID="txtNombreAnio" runat="server" CssClass="form-control" MaxLength="20"></asp:TextBox>
                </div>
            ...
            <div class="modal-inner">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-5">
                        ...
                        <asp:TextBox ID="txtEditarAnio" runat="server" CssClass="form-control" MaxLength="20"></asp:TextBox>
        ...
        <ItemTemplate>
            <div class="matri-row">
                ...
                <div class="matri-left">
                    ...
                    <div class="matri-title"><%# Eval("Periodo.descripcion") %></div>

                    <span id="pillTotal" runat="server"
                          class="count-pill"
                          title="Cantidad (ejemplo)">
                        Razón matriculas: <%# Eval("Matriculados") %> / <%# Eval("Disponibles") %>
                    </span>
                </div>
                ...
                <div class="matri-right">
                    ...
                    <asp:LinkButton ID="btnReporte" runat="server"
                        CssClass="btn btn-report" OnCommand="btnReporte_Command" ToolTip="Reporte por año"
                        CommandArgument='<%# Eval("Periodo.periodo_academico_id") + "|" + Eval("Periodo.nombre") %>'>

                ...
                <div class="mb-2 row g-4 align-items-start">
                    ...
                    <div class="col-lg-7">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-1">
                                <button type="button" class="btn-icon btn-muted" title="buscar" disabled><i class="fa-solid fa-magnifying-glass"></i></i></button>
                            </div>
                        </div>

                        <div class="mb-3 row">
                            <div class="col-md-4"><label class="form-label">Matricula:</label></div>
                        ...
                        <div class="mb-3 row">
                            <div class="col-md-4"><label class="form-label">Pensión:</label></div>
                            <div class="col-md-7"><asp:TextBox ID="txtPension" runat="server" CssClass="form-control readonly-gray" ReadOnly="true"></asp:TextBox></div>
                        </div>
                    </div>

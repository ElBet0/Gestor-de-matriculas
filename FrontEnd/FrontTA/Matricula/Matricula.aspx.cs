    ...
    public partial class Matricula : System.Web.UI.Page
    {
        ...
        private void BindGridsPeriodo()
        {
            ...
            foreach (var a in Periodos.OrderByDescending(x => x.Periodo.fecha_inicio.Year))
                dt.Rows.Add(a.Periodo.fecha_inicio.Year, a.Periodo.descripcion);
        ...
        protected void btnCrearOk_Click(object sender, EventArgs e)
        {
            ...
            var _periodo = new periodoAcademico()
            {
                ...
                descripcion = txtNombreAnio.Text,
                activo = 1
            };
        ...
        protected void btnEditOk_Click(object sender, EventArgs e)
        {
            ...
            _periodo.descripcion = txtEditarAnio.Text;



            var fmt = CultureInfo.InvariantCulture;

            if (DateTime.TryParseExact(sel.ToString() + "-03-01", "yyyy-MM-dd", fmt, DateTimeStyles.None, out DateTime fn))
            {
                fn = DateTime.SpecifyKind(fn.Date, DateTimeKind.Unspecified);
                _periodo.fecha_inicio = fn;
                _periodo.fecha_inicioSpecified = true;
            ...
            if (DateTime.TryParseExact(sel.ToString() + "-12-15", "yyyy-MM-dd", fmt, DateTimeStyles.None, out DateTime fn1))
            {
                fn1 = DateTime.SpecifyKind(fn1.Date, DateTimeKind.Unspecified);
                _periodo.fecha_fin = fn1;
                _periodo.fecha_finSpecified = true;
        ...
        protected void btnReporte_Command(object sender, CommandEventArgs e)
        {
            string[] datos = e.CommandArgument.ToString().Split('|');
            int idPeriodoReporte = int.Parse(datos[0]);
            Session["idPeriodoReporte"] = idPeriodoReporte;
            string nombrePeriodoReporte = datos[1];
            Session["nombrePeriodoReporte"] = nombrePeriodoReporte;
            Response.Redirect("VisualizarReporteMatriculasPeriodo.aspx");
        }
    }
}
